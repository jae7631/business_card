...
public class BusinessCardController {
   ...
   public ModelAndView test(ModelAndView mv, String id, Integer idx) throws Exception{
	  ObjectMapper om = new ObjectMapper();
      mv.addObject("jsonData", om.writeValueAsString(businessCardService.selectBusinessCard(id, idx)));
      mv.setViewName("create");
      return mv;
   }   
   ...
   public ResponseEntity<String> updateBusinessCard(@RequestParam("id")String id,@RequestParam("idx") Integer idx, @RequestParam("jsonData") String jsonData, @RequestParam("imgData")String imgData, String widthFlag)
   throws Exception{
      return businessCardService.updateBusinessCard(id, idx, jsonData, imgData, widthFlag);
   }
   
   //リスト作成
   @RequestMapping(value = "/createBusinessCard", method = RequestMethod.POST)
   public ResponseEntity<String> createBusinessCard(@RequestParam("jsonData") String jsonData, @RequestParam("fileName")String fileName, @RequestParam("imgData")String imgData, @RequestParam("widthFlag")String widthFlag) 
   throws Exception{
      return businessCardService.createBusinessCard(jsonData, fileName, imgData, widthFlag);
   }
