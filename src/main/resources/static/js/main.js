$(document).ready(function () {
        ...
        var widthFlag = getParam("f");
       	if(widthFlag === "y" || widthFlag === ""){
        ...
        $('#createBusinessCard').on("click", function(){
          ...
          document.body.removeChild(link);
        	...
        	createBusinessCard(fileName,jsonData,imgData,widthFlag);
        });
    	...
    	$('#update').on("click",function(){
    		if (confirm("名刺を修正しますか？") === true){
    			...
    			updateBusinessCard(idx,id,newData,imgData,widthFlag);
    		}
    	});
